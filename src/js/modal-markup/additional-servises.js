  ...
  return `<div class="birthday-extra__wrapper">
            ...
            <ul class="birthday-extra__list">
              <li class="birthday-extra__item">
                ...
                <p class="bithday-extra__description">350 грн за 1 дитину</p>
              </li>
              <li class="birthday-extra__item">
              ...
              <li class="birthday-extra__item">
                ...
                <p class="bithday-extra__description">80 грн шт</p>
              </li>
              <li class="birthday-extra__item">
                <p class="bithday-extra__description">Гелеві кульки</p>
                <p class="bithday-extra__description">1200 грн 20 шт</p>
              </li>
              <li class="birthday-extra__item">
                <p class="bithday-extra__description">Костюмований аніматор</p>
                <p class="bithday-extra__description">250 грн</p>
              </li>
              <li class="birthday-extra__item">
                <p class="bithday-extra__description">Лазертаг (нагрудник + пістолет)</p>
                <p class="bithday-extra__description">150 грн з дитини</p>
              </li>
              <li class="birthday-extra__item">
                <p class="bithday-extra__description">Піньята</p>
                <p class="bithday-extra__description">1200 грн</p>
              </li>
            </ul>
            ...
            <ul class="birthday-extra__list">
              <li class="birthday-extra__item">
                ...
                <p class="bithday-extra__description">1100 грн 1 кг</p>
              </li>
              <li class="birthday-extra__item">
              ...
              <li class="birthday-extra__item">
                ...
                <p class="bithday-extra__description">250 грн 1 пляшка</p>
              </li>
              <li class="birthday-extra__item">
            ...
            ${
              ...
              <li class="birthday-extra__item">
                ...
                <p class="bithday-extra__description">7500 грн</p>
              </li>
            </ul>`
                : `<ul class="birthday-extra__list">
              <li class="birthday-extra__item">
